...
export default function Hero() {
	return (
			<section className={`min-h-screen px-10 flex flex-col items-center justify-center ${raleway.className} text-center gap-8 md:gap-10 bg-custom-gradient`}>
				...
				<h5 className="max-w-[1000px] mx-auto xs:px-4 md:px-10">
					...
					pariatur et ipsam itaque eaque voluptatum, alias, at officiis 
